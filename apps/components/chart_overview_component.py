...
class ChartOverviewComponent:
  def __init__(self, merchandise, week_prices, day_prices, hour_prices, date, diff_with_btc, btc_week_prices=None, btc_day_prices=None, btc_hour_prices=None, abtc_week_prices=None, abtc_day_prices=None, abtc_hour_prices=None, show_other_merchandise=False, other_price_data=None):
  ...
  def run(self):
    ...
    chart_hour_object = self.render_chart(self.merchandise, self.week_prices,
                      self.day_prices, self.hour_prices)

    self.render_chart("BTC", self.btc_week_prices,
                      self.btc_day_prices, self.btc_hour_prices)
    
    self.render_chart(f"{self.merchandise}/BTC", self.abtc_week_prices,
                      self.abtc_day_prices, self.abtc_hour_prices)
